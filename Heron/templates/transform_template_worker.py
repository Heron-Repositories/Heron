...
def start_the_worker_process():
    ...
    The pull_port is the port that the worker uses to pull link from the _com process (the _com's push_port)
    The push_port is the port that the worker uses to push link to the _com process(the com's pull_port)
