...
ParameterNames = ['File name', 'Append on Axis', 'dtype']
ParameterTypes = ['str', 'int', 'list']
ParametersDefaultValues = ['output.bin', 0, ['Same', 'int8', 'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32',
